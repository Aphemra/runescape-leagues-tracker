    ...
    <div className="filters-panel">
          ...
          {manifest.tiers.map((tier) => (
            <label className={`check-chip check-chip--tier check-chip--${tier.id}`} key={tier.id}>
              <input
                ...
                onChange={() => patch({ tierIds: toggleValue(filters.tierIds, tier.id) })}
              />
      ...
      <div className="filter-group">
        ...
        <select
          ...
          onChange={(event) => patch({ requirements: event.target.value as LeagueFilterState["requirements"] })}
        >
      ...
      <div className="filter-group filter-group--sort">
        ...
        <div>
          <select
            ...
            onChange={(event) => patch({ sortField: event.target.value as LeagueFilterState["sortField"] })}
          >
          ...
          <button
            ...
            type="button"
            onClick={() => patch({ sortDirection: filters.sortDirection === "asc" ? "desc" : "asc" })}
